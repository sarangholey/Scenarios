...
public class Assignment1 {
    ...
    driver.findElement(By.xpath("//input[@class='_2zrpKA _1dBPDZ']")).sendKeys("7574840889");;
    driver.findElement(By.xpath("//input[@type='password']")).sendKeys("priti333");
    ...
    List<WebElement>Prices=driver.findElements(By.className("_1vC4OE"));
    int n=Prices.size();	
